                                    ...
                                    <div class="flex items-center gap-3">
                                        <a
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                class="bi bi-eye size-4" viewBox="0 0 16 16">
                                                <path
                                        ...
                                        <a
                                            :href="`{{ route('admin.customers.edit', '__id__') }}`.replace('__id__', customer
                                                .id)">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="size-4 stroke-sky-500">
