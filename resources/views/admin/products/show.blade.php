    ...
    <div class="py-12" x-data="viewProduct">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="space-y-5">
                    <div class="relative w-full min-h-80 rounded-md overflow-hidden">
                    ...
                    <div class="flex items-center space-x-5">
                        ...
                        <template x-if="!product.variations">
                    ...
                    <template x-for="variation in selectedVariationGroup" :key="variation.id">
                        <div class="flex items-center justify-between" x-data="{
                            ...
                            increaseVariationQuantity() {
                                if (this.userSelectedQuantity < variation.variation_stock_quantity) {
                                    this.userSelectedQuantity++;
                                }
                            }
                        }">
