    ...
    <div
        ...
        <div>
            <a href="#" class=" w-fit text-2xl font-bold text-black dark:text-white">
                ...
                <p class="text-lg font-bold">Sho<span class="text-blue-400">ps</span>mart</p>
            </a>
            ...
            <ul class="text-sm mt-3 list-decimal list-inside">
                <li>Westlands, The Sarit Center Mall, Nairobi</li>
                <li>Nyali, City Mall, Mombasa</li>
            </ul>
        </div>
        <div>
            <span
            ...
            <div class="flex flex-col gap-2 text-sm mt-5">
                ...
                <a href="{{ route('category.products.show', 'Health & Beauty') }}">Health & Beauty</a>
                <a href="{{ route('category.products.show', 'Fashion') }}">Fashion</a>
            </div>
        </div>
