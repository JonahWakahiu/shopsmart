        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-start gap-7">
                <div class="col-span-3 ">
                    ...
                    <div class="px-5 py-2 flex items-center  bg-orange-500 text-white rounded-md mb-7">
                                    ...
                                    <div>
                                        ...
                                        <div
                                            ...
                                            <button
                                                ...
                                                class="bg-slate-100 rounded-md p-0.5 shadow-md border border-slate-200 flex items-center justify-center text-blue-500"
                                                type="button">
                ...
                <div class="col-span-1 ">
                    <div class="bg-orange-500 rounded-md flex items-center flex-col p-5">
                        <p class="text-white">Have a promo code?</p>
                        <div class="flex items-center gap-5 mt-3">
                            <x-text-input class="w-24 py-1" />
                            <button type="button" class="bg-slate-100 rounded-md text-sm py-1 px-3">Apply</button>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 flex items-center flex-wrap justify-end gap-3">
                        <button
                            class="min-w-fit px-3 bg-orange-500 text-white rounded-md text-sm font-medium py-2 hover:bg-orange-500/80 flex-shrink-0 ">Continue
                            Shopping</button>
                        ...
                        <form action="{{ route('checkout') }}" method="POST" class="flex-shrink-0">
                            ...
                            <button type="submit"
                                class="min-w-fit px-3 bg-green-500 text-white rounded-md text-sm font-medium py-2 hover:bg-green-500/80 ">
                                Buy Now
                            </button>
                        </form>
                    </div>
