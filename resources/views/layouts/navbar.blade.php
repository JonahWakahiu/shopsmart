<nav class="flex items-center justify-between sm:px-6 lg:px-8 py-4">
    <a href="#" class="ml-2 w-fit text-2xl font-bold text-black dark:text-white">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 376 155" fill="none" class="w-24" aria-hidden="true">
            ...
            <path
                ...
                class="fill-blue-700 dark:fill-blue-600"></path>
            <g>
                <path
    ...
    <div class="flex items-center gap-4">
        <button class="size-8 flex items-center justify-center rounded-full bg-white dark:bg-slate-800">
        ...
        <a href="{{ route('cart') }}" class="relative">
            ...
            <div x-cloak x-show="$store.cart.count > 0"
                class="absolute top-0 -right-1 translate-x-1/2 -translate-y-1/2  inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-semibold leading-4 bg-red-500 text-white">
        ...
        <button class="relative w-fit ">
            ...
            <span
                class="absolute top-0 right-1 translate-x-1/2 -translate-y-1/2 size-2 rounded-full bg-red-600 text-xs font-medium"></span>
        </button>
            ...
            <div x-cloak x-show="open" @click.outside="open = false" x-transition
                ...
                <div>
                    <a href="{{ route('profile.edit') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-columns-gap size-4"
                            viewBox="0 0 16 16">
                            <path
