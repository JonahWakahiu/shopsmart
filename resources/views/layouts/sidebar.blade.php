<nav x-cloak
    ...
    {{-- Sidebar Links --}}
    <div class="flex flex-col gap-2 oveflow-y-auto pb-6">
        ...
        <div x-data="{ isExpanded: @js(request()->routeIs('admin.products.*', 'admin.categories.*') ? true : false) }" class="flex flex-col">
            <button type="button" @click="isExpanded = ! isExpanded"
                ...
                <span class="mr-auto text-left">Products Management</span>
        ...
        <div x-data="{ isExpanded: @js(request()->routeIs('admin.roles.*', 'admin.permissions.*') ? true : false) }" class="flex flex-col">
            <button type="button" @click="isExpanded = ! isExpanded"
                ...
                <span class="mr-auto text-left">Roles & Permissions</span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                    class="size-5 transition-transform rotate-0 shrink-0"
                    x-bind:class="isExpanded ? 'rotate-180' : 'rotate-0'" aria-hidden="true">
                    <path fill-rule="evenodd"
